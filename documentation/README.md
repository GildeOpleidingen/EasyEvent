...
```
cd existing_repo
git remote add origin https://gitlab.gdcs.gildedevops.it/evenement/evenementen-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.gdcs.gildedevops.it/evenement/evenementen-app/-/settings/integrations)
