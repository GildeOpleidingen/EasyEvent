        ...
        <div class="container mt-4">
            ...
            <form action="" class="needs-validation" novalidate>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-4">
                        <label for="eventBeginTime" class="form-label">Begintijd</label>
                    ...
                    <div class="col-md-4">
                        <label for="eventEndTime" class="form-label">Eindtijd</label>
                ...
                <div class="mb-3">
                    <label for="eventImage" class="form-label">Afbeelding</label>
                    <input type="file" class="form-control" id="eventImage" name="image" accept="image/*" onchange="previewImage(event)" required>
                    <div class="invalid-feedback">Kies een afbeelding.</div>
                </div>

                <div class="mb-3">
                    <label class="form-label">Afbeelding Voorbeeld</label>
